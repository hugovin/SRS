            ...
            <div class="span10">
                <div class="row span10">
                    <h2>
                        Filters</h2>
                    <div class="span10">
                        <input type="text" class="span4" id="txtRoomName" placeholder="Type Building Name…" />
                        <select class="span4">
                ...
                <div class="row span10">
                    ...
                    <a href="#myModal" role="button" class="btn btn-success" data-toggle="modal">Create A new Building</a>
                </div>
            </div>
            <div class="row span10">
            </div>
